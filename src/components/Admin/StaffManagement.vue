...
<h3>User Table</h3> 
  <table id="staffTable">
    ...
    <tr v-for="employee in staff" :key="employee._id">
      ...
      <td>{{ employee.role }}</td>
      <td>
        <button class="delete-button" @click="confirmDelete(employee._id)">Kick</button>
      </td>
    </tr>
  </table>
  ...
  <div class="formbold-form-wrapper">
    ...
    <form @submit.prevent="handleSubmit" novalidate>
      <div class="formbold-mb-3">
        ...
        <label for="email" class="formbold-form-label"> <h5>Email:</h5> </label>
        <input
        placeholder="Email..."
        ...
        <label for="password" class="formbold-form-label"> <h5>Password:</h5> </label>
        <input
        ...
        <select class="formbold-form-input" required v-model="role">
          ...
          <option selected class="formbold-form-input" value="Staff">Staff</option>
        </select>

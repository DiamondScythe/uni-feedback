      ...
      <section id="terms-of-service">
        <div class="card">
          ...
          <p class="paragraph">
            ...
            occurs under your account. You agree to notify UNF immediately of
            any unauthorized use of your account or any other breach of
            security.
            <br /><br /><br />
            3) User Content: You are solely responsible for any content that you
            post, upload, or otherwise submit to this website ("User Content").
            You represent and warrant that you have all necessary rights to
            submit your User Content and that your User Content does not
            infringe on the intellectual property rights or other rights of any
            third party. You grant UNF a non-exclusive, transferable,
            sub-licensable, royalty-free, worldwide license to use, reproduce,
            modify, adapt, publish, translate, create derivative works from,
            distribute, perform, and display your User Content in connection
            with the operation of this website and the provision of services to
            users.
            <br /><br /><br />

...
<div class="container">
  <!-- Main content -->
  <div class="row">
    <div class="col-lg-8" style="margin-bottom: ($spacer * .25) !important;">
      <!-- Details -->
      <div class="card mb-4" >
        <div class="card-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex mb-2">
                    <div class="flex-lg-grow-1 ms-3">
                      <h6 class=" text-reset"> {{ details.user_id }} </h6>
                      <span class="small"></span>
                    </div>
                  </div>
                </td>
                ...
                <td>
                  <div class="d-flex mb-2">
                    <div class="flex-lg-grow-1 ms-3" v-if="fileExists">
                      <h6 class=" text-reset"> <a :href="downloadLink">{{ details.file_name }}</a> </h6>
                      <span class="small"></span>
                    </div>
    ...
    <div class="col-lg-4">
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <p>Greenwich facility on Cong Hoa Street is temporarily closed. Please check your email daily to acquire latest news.</p>
        </div>
      </div>
      <div class="card mb-4">
